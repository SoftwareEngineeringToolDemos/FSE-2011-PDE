...
namespace Tum.FamilyTreeDSL
{
	...
	/// </remarks>
	public partial class FamilyTreeDSLToolboxHelper : FamilyTreeDSLToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new FamilyTreeDSLToolboxHelper.
		/// </summary>
		public FamilyTreeDSLToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	/// Helper class used to create and initialize toolbox items for this DSL.
	/// </summary>
	public abstract class FamilyTreeDSLToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify FamilyTreeDSL toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "FamilyTreeDSL..";

		private global::System.IServiceProvider sp;
		
		/// <summary>
		/// Constructs a new FamilyTreeDSLToolboxHelperBase.
		/// </summary>
		protected FamilyTreeDSLToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
