...
{
	partial class FamilyTreeDSLDomainModel
	{
		///<Summary>
		...
		partial void InitializeSerialization(DslModeling::Store store)
		{
			// Register the serializers and moniker resolver for this model
			 FamilyTreeDSLSerializationHelper.Instance.InitializeSerialization(store);	
		}
	}
}
...
namespace Tum.FamilyTreeDSL
{
	...
	/// <summary>
	/// Helper class for serializing and deserializing FamilyTreeDSL models.
	/// </summary>
	public abstract partial class FamilyTreeDSLSerializationHelperBase : DslEditorModeling::SerializationHelper
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected FamilyTreeDSLSerializationHelperBase() { }
		#endregion
		...
		public virtual object ConvertTypedObjectTo(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement modelELement, string propertyName, object value, System.Type sourceType, bool? isRequired)
		{
			...
			if( sourceType == typeof(global::Tum.FamilyTreeDSL.Gender?) && value != null )
			{
				global::Tum.FamilyTreeDSL.Gender? strValue = value as global::Tum.FamilyTreeDSL.Gender?;
				if( strValue != null )
					switch(strValue)
					{
						case global::Tum.FamilyTreeDSL.Gender.Male:
							return "Male";
						case global::Tum.FamilyTreeDSL.Gender.Female:
							return "Female";

						default:
							throw new System.NotSupportedException("Value of type Gender is unknown.");
					}
			}
		...
		internal protected virtual void InitializeSerialization(DslModeling::Store store)
		{
			...
			directory.AddBehavior(FamilyTreeDSLSerializationBehavior.Instance);
		}
		...
		public static void InitializeSerializers(DslModeling::DomainXmlSerializerDirectory directory, DslModeling::DomainDataDirectory domainDataDirectory)
		{
			...
			typeEmbeddedDerivedNameTypes.Add(global::Tum.FamilyTreeDSL.FamilyTreeModel.DomainClassId, new System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<System.Guid>>());
			// add dictionary informations...
			typeDerivedNameTypes.Add(global::Tum.FamilyTreeDSL.Person.DomainClassId, new System.Collections.Generic.Dictionary<string, System.Guid>());
			AddTypeDerivedNameTypesElement(global::Tum.FamilyTreeDSL.Person.DomainClassId, "FamilyTreePerson", global::Tum.FamilyTreeDSL.FamilyTreePerson.DomainClassId);
				
			typeEmbeddedDerivedNameTypes.Add(global::Tum.FamilyTreeDSL.FamilyTreePerson.DomainClassId, new System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<System.Guid>>());
		...
		#region Serialization Methods for FamilyTreeModel
		/// <summary>
        ...
        public virtual global::Tum.FamilyTreeDSL.FamilyTreeModel LoadModelFamilyTreeModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
        {
            ...
            {
                throw new global::System.InvalidOperationException(FamilyTreeDSLDomainModel.SingletonResourceManager.GetString("MissingTransaction"));
            }
			...
			DslModeling::DomainClassXmlSerializer modelRootSerializer = directory.GetSerializer(global::Tum.FamilyTreeDSL.FamilyTreeModel.DomainClassId);
			...
			if (modelRootSerializer != null)
			{
				...
				try
				{
					...
					//{
						...
						{
							global::System.Xml.XmlReaderSettings settings = FamilyTreeDSLSerializationHelper.Instance.CreateXmlReaderSettings(serializationContext, false);
							using (global::System.Xml.XmlReader reader = global::System.Xml.XmlReader.Create(fileStream, settings))
							{
								...
								{	
									...
									modelRoot = modelRootSerializer.TryCreateInstance(serializationContext, reader, partition) as global::Tum.FamilyTreeDSL.FamilyTreeModel;
									if (modelRoot != null && !serializationResult.Failed)
									{
										modelRoot.DomainFilePath = fileName;
										this.ReadRootElementFamilyTreeModel(serializationContext, modelRoot, reader, schemaResolver);
									}
						...
						if(modelRoot == null && !serializationResult.Failed)
						{
							...
							modelRoot = this.CreateModelHelperFamilyTreeModel(partition);
							modelRoot.DomainFilePath = fileName;
						}
						//if (t.IsActive)
						//	t.Commit();
		...
		/// </summary>
		internal protected virtual global::Tum.FamilyTreeDSL.FamilyTreeModel CreateModelHelperFamilyTreeModel(DslModeling::Partition modelPartition)
		{
			global::Tum.FamilyTreeDSL.FamilyTreeModel model = new global::Tum.FamilyTreeDSL.FamilyTreeModel(modelPartition, 
				global::Tum.FamilyTreeDSL.FamilyTreeDSLDomainModelIdProvider.Instance.AssignId(null));
			if( FamilyTreeDSLElementNameProvider.Instance.HasName(model) )
				FamilyTreeDSLElementNameProvider.Instance.SetName(model, "FamilyTreeModel");
		...
		protected virtual void ReadRootElementFamilyTreeModel(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement rootElement, global::System.Xml.XmlReader reader, DslModeling::ISchemaResolver schemaResolver)
		{
			#region Check Parameters
		...
		public virtual void SaveModelFamilyTreeModel(DslModeling::SerializationResult serializationResult, global::Tum.FamilyTreeDSL.FamilyTreeModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
			...
			try
			{
				...
				global::System.Xml.XmlWriterSettings settings = FamilyTreeDSLSerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, false, encoding);
				...
				this.WriteRootElementFamilyTreeModel(serializationContext, modelRoot, writer, options);
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
        [global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
        public virtual void TemporarlySaveModelFamilyTreeModel(DslModeling::SerializationResult serializationResult, global::Tum.FamilyTreeDSL.FamilyTreeModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
        {
            #region Check Parameters
            if (serializationResult == null)
                throw new global::System.ArgumentNullException("serializationResult");
		...
		public virtual void WriteRootElementFamilyTreeModel(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement rootElement, global::System.Xml.XmlWriter writer, DslEditorModeling::SerializationOptions options)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert(serializationContext != null);
			if (serializationContext == null)
		...
		public virtual string GetSerializedModelStringFamilyTreeModel(global::Tum.FamilyTreeDSL.FamilyTreeModel modelRoot, global::System.Text.Encoding encoding, DslEditorModeling.SerializationMode serializationMode)
		{
			...
			using (global::System.IO.MemoryStream modelFileContent = this.InternalSaveModelFamilyTreeModel(serializationResult, modelRoot, string.Empty, encoding, false, serializationMode))
			{
	...
	/// <summary>
	/// Double derived helper class for serializing and deserializing FamilyTreeDSL models.
	/// </summary>
	public sealed partial class FamilyTreeDSLSerializationHelper : FamilyTreeDSLSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		private FamilyTreeDSLSerializationHelper() : base() { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static FamilyTreeDSLSerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static FamilyTreeDSLSerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (FamilyTreeDSLSerializationHelper.instance == null)
					FamilyTreeDSLSerializationHelper.instance = new FamilyTreeDSLSerializationHelper();
				return FamilyTreeDSLSerializationHelper.instance;
			}
		}
		#endregion
	}
