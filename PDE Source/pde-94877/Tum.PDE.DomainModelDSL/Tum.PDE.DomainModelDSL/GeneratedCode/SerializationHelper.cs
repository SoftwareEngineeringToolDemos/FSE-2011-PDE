...
{
	partial class TestLanguageDomainModel
	{
		///<Summary>
		...
		partial void InitializeSerialization(DslModeling::Store store)
		{
			// Register the serializers and moniker resolver for this model
			 TestLanguageSerializationHelper.Instance.InitializeSerialization(store);	
		}
	}
}
...
namespace Tum.TestLanguage
{
	...
	/// <summary>
	/// Helper class for serializing and deserializing TestLanguage models.
	/// </summary>
	public abstract partial class TestLanguageSerializationHelperBase : DslEditorModeling::SerializationHelper
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected TestLanguageSerializationHelperBase() { }
		#endregion
		...
		internal protected virtual void InitializeSerialization(DslModeling::Store store)
		{
			...
			directory.AddBehavior(TestLanguageSerializationBehavior.Instance);
		}
		...
		public static void InitializeSerializers(DslModeling::DomainXmlSerializerDirectory directory, DslModeling::DomainDataDirectory domainDataDirectory)
		{
			...
			typeEmbeddedDerivedNameTypes.Add(global::Tum.TestLanguage.DomainModel.DomainClassId, new System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<System.Guid>>());
        ...
        public virtual global::Tum.TestLanguage.DomainModel LoadModelDomainModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
        {
            #region Check Parameters
            ...
            {
                throw new global::System.InvalidOperationException(TestLanguageDomainModel.SingletonResourceManager.GetString("MissingTransaction"));
            }
			...
			DslModeling::DomainClassXmlSerializer modelRootSerializer = directory.GetSerializer(global::Tum.TestLanguage.DomainModel.DomainClassId);
			...
			if (modelRootSerializer != null)
			{
				...
				try
				{
					...
					//{
						...
						{
							global::System.Xml.XmlReaderSettings settings = TestLanguageSerializationHelper.Instance.CreateXmlReaderSettings(serializationContext, false);
							using (global::System.Xml.XmlReader reader = global::System.Xml.XmlReader.Create(fileStream, settings))
							{
								...
								{	
									...
									modelRoot = modelRootSerializer.TryCreateInstance(serializationContext, reader, partition) as global::Tum.TestLanguage.DomainModel;
		...
		public virtual void SaveModelDomainModel(DslModeling::SerializationResult serializationResult, global::Tum.TestLanguage.DomainModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
			...
			try
			{
				...
				global::System.Xml.XmlWriterSettings settings = TestLanguageSerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, false, encoding);
		...
		private global::System.IO.MemoryStream InternalSaveModelDomainModel(DslModeling::SerializationResult serializationResult, global::Tum.TestLanguage.DomainModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue, DslEditorModeling.SerializationMode serializationMode)
		{
			#region Check Parameters
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
        [global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
        public virtual void TemporarlySaveModelDomainModel(DslModeling::SerializationResult serializationResult, global::Tum.TestLanguage.DomainModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
        {
            #region Check Parameters
            if (serializationResult == null)
                throw new global::System.ArgumentNullException("serializationResult");
		...
		public virtual string GetSerializedModelStringDomainModel(global::Tum.TestLanguage.DomainModel modelRoot, global::System.Text.Encoding encoding, DslEditorModeling.SerializationMode serializationMode)
		{
	...
	/// <summary>
	/// Double derived helper class for serializing and deserializing TestLanguage models.
	/// </summary>
	public sealed partial class TestLanguageSerializationHelper : TestLanguageSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		private TestLanguageSerializationHelper() : base() { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static TestLanguageSerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static TestLanguageSerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (TestLanguageSerializationHelper.instance == null)
					TestLanguageSerializationHelper.instance = new TestLanguageSerializationHelper();
				return TestLanguageSerializationHelper.instance;
			}
		}
		#endregion
	}
