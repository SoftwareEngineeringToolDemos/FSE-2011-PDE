...
{
    public class IncludedDiagramClassViewModel : BaseModelElementViewModel
    {
        ...
        public override Microsoft.VisualStudio.Modeling.ModelElement GetHostedElement()
        {
            ...
            return DesignerDiagramClassReferencesIncludedDiagramClasses.GetLink(ParentDesignerClass, this.Element as DiagramClass);
        }
