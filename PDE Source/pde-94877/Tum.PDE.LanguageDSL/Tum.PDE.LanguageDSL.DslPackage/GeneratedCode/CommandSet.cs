...
namespace Tum.PDE.LanguageDSL
{
	...
	/// </summary>
	internal partial class LanguageDSLCommandSet : LanguageDSLCommandSetBase
	{
		/// <summary>
		/// Constructs a new LanguageDSLCommandSet.
		/// </summary>
		public LanguageDSLCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class LanguageDSLCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new LanguageDSLCommandSetBase.
		/// </summary>
		protected LanguageDSLCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewLanguageDSLExplorerCommand,
				typeof(LanguageDSLEditorFactory).GUID);
		...
		{
			LanguageDSLExplorerToolWindow explorer = this.LanguageDSLExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentLanguageDSLDocData != null && this.CurrentLanguageDSLDocData.Store != null)
			{
				this.CurrentLanguageDSLDocData.ValidationController.Validate(this.CurrentLanguageDSLDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentLanguageDSLDocData != null && this.CurrentLanguageDSLDocData.Store != null)
			{
				...
				this.CurrentLanguageDSLDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected LanguageDSLDocData CurrentLanguageDSLDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as LanguageDSLDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected LanguageDSLDocView CurrentLanguageDSLDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as LanguageDSLDocView;
			}
		}
		...
		/// </summary>
		protected LanguageDSLExplorerToolWindow LanguageDSLExplorerToolWindow
		{
			get
			{
				LanguageDSLExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(LanguageDSLExplorerToolWindow), true) as LanguageDSLExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				LanguageDSLExplorerToolWindow explorerWindow = this.LanguageDSLExplorerToolWindow;
