...
namespace Tum.PDE.LanguageDSL
{
	...
	/// </remarks>
	public partial class LanguageDSLToolboxHelper : LanguageDSLToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new LanguageDSLToolboxHelper.
		/// </summary>
		public LanguageDSLToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	/// Helper class used to create and initialize toolbox items for this DSL.
	/// </summary>
	public abstract class LanguageDSLToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify LanguageDSL toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "LanguageDSL.1.0";

		private global::System.IServiceProvider sp;
		
		/// <summary>
		/// Constructs a new LanguageDSLToolboxHelperBase.
		/// </summary>
		protected LanguageDSLToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
