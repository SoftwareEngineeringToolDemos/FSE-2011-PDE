...
namespace Tum.PDE.LanguageDSL
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides LanguageDSL files
	/// The implementation is done in LanguageDSLDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class LanguageDSLDirectiveProcessor : LanguageDSLDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public LanguageDSLDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides LanguageDSL files
	/// </summary>
	public class LanguageDSLDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string LanguageDSLDirectiveProcessorName = "LanguageDSLDirectiveProcessor";
		...
		/// </summary>
		private const string supportedDirectiveName = "LanguageDSL";
		...
		/// Constructor
		/// </summary>
		public LanguageDSLDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return LanguageDSLDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Tum.PDE.LanguageDSL.MetaModel));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::Tum.PDE.LanguageDSL.MetaModel));
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"Tum.PDE.LanguageDSL.LanguageDSLDomainModel",
					};
			...
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				if (languageProvider != null)
				{
					...
					invokeLoad = new global::System.CodeDom.CodeMethodInvokeExpression(
						new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeFieldReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression(typeof(LanguageDSLSerializationHelper)), "Instance"), "LoadModel"), new global::System.CodeDom.CodeVariableReferenceExpression("serializationResult"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"), new global::System.CodeDom.CodePrimitiveExpression(requiresArguments[requiresFileParameter]), new global::System.CodeDom.CodePrimitiveExpression(null), new global::System.CodeDom.CodePrimitiveExpression(null), new global::System.CodeDom.CodePrimitiveExpression(null));
		...
		public override string[] GetImportsForProcessingRun()
		{
			...
			imports.Add("Tum.PDE.LanguageDSL");
