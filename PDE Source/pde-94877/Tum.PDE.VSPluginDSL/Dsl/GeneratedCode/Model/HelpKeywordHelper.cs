...
namespace Tum.PDE.VSPluginDSL
{
	...
	/// </remarks>
	public partial class VSPluginDSLHelpKeywordHelper : VSPluginDSLHelpKeywordHelperBase 
	{
		/// <summary>
		/// Constructs a new VSPluginDSLHelpKeywordHelper.
		/// </summary>
		protected VSPluginDSLHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the VSPluginDSLHelpKeywordHelper.
		/// </summary>
		public static VSPluginDSLHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class VSPluginDSLHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new VSPluginDSLHelpKeywordHelperBase.
		/// </summary>
		protected VSPluginDSLHelpKeywordHelperBase()
			: base() { }
