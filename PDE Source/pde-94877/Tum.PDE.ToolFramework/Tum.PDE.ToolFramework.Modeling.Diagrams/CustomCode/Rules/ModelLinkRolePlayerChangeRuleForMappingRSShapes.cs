...
namespace Tum.PDE.ToolFramework.Modeling.Diagrams
{
    ...
    /// </summary>	
    public abstract class ModelLinkRolePlayerChangeRuleForMappingRSShapes : RolePlayerChangeRule
    {
        ...
        public ModelLinkRolePlayerChangeRuleForMappingRSShapes(RolePlayerChangeHelper rpHelper)
        {
        ...
        {
            private ModelLinkAddRuleForMappingRSShapes.RSShapesFactoryHelper factoryHelper;
            private ModelElementDeletingRuleForMappingRSShapes.ShapeDeletionHelper deletionHelper;
