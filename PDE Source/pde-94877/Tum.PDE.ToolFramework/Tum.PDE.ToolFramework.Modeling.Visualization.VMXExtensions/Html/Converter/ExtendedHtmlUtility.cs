...
{
    /// <summary>
    /// SOURCE: http://conceptdevelopment.net/Localization/HtmlEncode/code3.html 
    /// </summary>
    public class ExtendedHtmlUtility
    {
        ...
        /// <param name="encodeTagsToo"></param>
        /// <returns>
        /// 0-9a-zA-Z and some punctuation (ASCII, basically) remain unchanged,
        ...
        private static string ResolveEntityNotAngleAmp(System.Text.RegularExpressions.Match matchToProcess)
        {
            ...
            {
                x = Convert.ToChar(Convert.ToInt32(matchToProcess.Groups["decimal"].Value)).ToString();
            }
            else if (matchToProcess.Groups["hex"].Success)
            {
                x = Convert.ToChar(HexToInt(matchToProcess.Groups["hex"].Value)).ToString();
            }
        ...
        private static string EntityLookup(string entity)
        {
            ...
            switch (entity)
            {
                case "Aacute": x = Convert.ToChar(0x00C1).ToString(); break;
                case "aacute": x = Convert.ToChar(0x00E1).ToString(); break;
                case "acirc": x = Convert.ToChar(0x00E2).ToString(); break;
                case "Acirc": x = Convert.ToChar(0x00C2).ToString(); break;
                case "acute": x = Convert.ToChar(0x00B4).ToString(); break;
                ...
                case "emsp": x = Convert.ToChar(0x2003).ToString(); break;
                ...
                case "equiv": x = Convert.ToChar(0x2261).ToString(); break;
                ...
                case "frasl": x = Convert.ToChar(0x2044).ToString(); break;
                case "gamma": x = Convert.ToChar(0x03B3).ToString(); break;
                case "Gamma": x = Convert.ToChar(0x393).ToString(); break;
                case "ge": x = Convert.ToChar(0x2265).ToString(); break;
                case "gt": x = Convert.ToChar(0x003E).ToString(); break;
                case "hArr": x = Convert.ToChar(0x21D4).ToString(); break;
                ...
                case "Igrave": x = Convert.ToChar(0x00CC).ToString(); break;
                ...
                case "Iota": x = Convert.ToChar(0x0399).ToString(); break;
                ...
                case "middot": x = Convert.ToChar(0x00B7).ToString(); break;
                ...
                case "notin": x = Convert.ToChar(0x2209).ToString(); break;
                ...
                case "nu": x = Convert.ToChar(0x03BD).ToString(); break;
                ...
                case "OElig": x = Convert.ToChar(0x0152).ToString(); break;
                case "oelig": x = Convert.ToChar(0x0153).ToString(); break;
                ...
                case "Omicron": x = Convert.ToChar(0x039F).ToString(); break;
                case "omicron": x = Convert.ToChar(0x03BF).ToString(); break;
                case "oplus": x = Convert.ToChar(0x2295).ToString(); break;
                ...
                case "oslash": x = Convert.ToChar(0x00F8).ToString(); break;
                case "otilde": x = Convert.ToChar(0x00F5).ToString(); break;
                case "Otilde": x = Convert.ToChar(0x00D5).ToString(); break;
                case "otimes": x = Convert.ToChar(0x2297).ToString(); break;
                ...
                case "shy": x = Convert.ToChar(0x00AD).ToString(); break;
                case "sigma": x = Convert.ToChar(0x03C3).ToString(); break;
                case "Sigma": x = Convert.ToChar(0x03A3).ToString(); break;
                ...
                case "sup1": x = Convert.ToChar(0x00B9).ToString(); break;
                ...
                case "Tau": x = Convert.ToChar(0x03A4).ToString(); break;
                case "tau": x = Convert.ToChar(0x03C4).ToString(); break;
                case "there4": x = Convert.ToChar(0x2234).ToString(); break;
                ...
                case "Uacute": x = Convert.ToChar(0x00DA).ToString(); break;
                ...
                case "Uuml": x = Convert.ToChar(0x00DC).ToString(); break;
