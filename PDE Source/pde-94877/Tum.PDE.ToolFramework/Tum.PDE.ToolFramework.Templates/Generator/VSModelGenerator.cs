...
{
    public class VSModelGenerator : BaseGenerator
    {
        /// <summary>
        ...
        protected override void RunCore()
        {
            ...
            this.Run(new Shell.Model.DocumentDataGenerator(), "DocumentData.cs");
            ...
            this.Run(new Shell.Model.DirectiveProcessorGenerator(), "DirectiveProcessor.cs");
            this.Run(new Shell.Model.HelpKeywordHelperGenerator(), "HelpKeywordHelper.cs");
            this.Run(new Shell.Model.SerializationHelperGenerator(), "SerializationHelperShell.cs");
            this.Run(new Shell.Model.ToolboxHelperGenerator(), "ToolboxHelper.cs");
