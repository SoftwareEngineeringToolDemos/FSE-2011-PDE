...
{
	/// <summary>
    /// View model for DomainElementShape.
	///
	/// Double-derived class to allow easier code customization.
    /// </summary>
	public partial class DomainElementShapeDiagramItemViewModel : DomainElementShapeDiagramItemViewModelBase
	{
		#region Constructor
		/// <summary>
        /// Constuctor.
        ...
        public DomainElementShapeDiagramItemViewModel(DslEditorViewModelData::ViewModelStore viewModelStore, DslEditorViewDiagrams::DiagramSurfaceViewModel diagram, DslEditorDiagrams::NodeShape shapeElement)
    ...
    /// </summary>
	public partial class DomainElementShapeDiagramItemViewModelBase : DslEditorViewDiagrams::DiagramItemElementViewModel
	{
		#region Constructor
		/// <summary>
        /// Constuctor.
		...
		/// </summary>
		public global::System.String Element_Description
		{
			get
			{
				return (this.Element as global::Tum.PDE.ModelingDSL.DomainElement).Description;
			}
			set
			{
				if( (this.Element as global::Tum.PDE.ModelingDSL.DomainElement).Description != value )
				{
					using( DslModeling::Transaction transaction = this.Store.TransactionManager.BeginTransaction("Update value of Description") )
					{
						(this.Element as global::Tum.PDE.ModelingDSL.DomainElement).Description = value;
