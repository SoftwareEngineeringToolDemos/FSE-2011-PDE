...
namespace Tum.PDE.ModelingDSL
{
	...
	/// </summary>
	public partial class PDEModelingDSLDomainModelIdProvider : PDEModelingDSLDomainModelIdProviderBase
	{
		#region Singleton Instance
		/// <summary>
		/// Singleton instance.
		/// </summary>
		private static PDEModelingDSLDomainModelIdProvider instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static PDEModelingDSLDomainModelIdProvider Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (PDEModelingDSLDomainModelIdProvider.instance == null)
					PDEModelingDSLDomainModelIdProvider.instance = new PDEModelingDSLDomainModelIdProvider();
				return PDEModelingDSLDomainModelIdProvider.instance;
			}
		}
		private PDEModelingDSLDomainModelIdProvider(){}
		#endregion
	}
	...
	/// </summary>
	public abstract class PDEModelingDSLDomainModelIdProviderBase : DslEditorModeling::IModelElementIdProvider
	{
		...
		/// Constructor.
		/// </summary>
		protected PDEModelingDSLDomainModelIdProviderBase()
		{
        ...
        public virtual bool RemoveKey(DslModeling::ModelElement modelElement, System.Collections.Generic.List<DslEditorModeling::IDomainModelServices> servicesToDiscard)
		{
			...
			discard.Add(PDEModelingDSLDomainModelServices.Instance);

			foreach(DslEditorModeling::IDomainModelServices externService in PDEModelingDSLDomainModelExtensionServices.Instance.ExternServices)
			{
