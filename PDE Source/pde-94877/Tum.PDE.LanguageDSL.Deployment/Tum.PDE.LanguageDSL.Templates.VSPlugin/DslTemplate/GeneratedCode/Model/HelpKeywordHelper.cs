...
namespace Tum.PDE.ModelingDSL
{
	...
	/// </remarks>
	public partial class PDEModelingDSLHelpKeywordHelper : PDEModelingDSLHelpKeywordHelperBase 
	{
		/// <summary>
		/// Constructs a new PDEModelingDSLHelpKeywordHelper.
		/// </summary>
		protected PDEModelingDSLHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the PDEModelingDSLHelpKeywordHelper.
		/// </summary>
		public static PDEModelingDSLHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class PDEModelingDSLHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new PDEModelingDSLHelpKeywordHelperBase.
		/// </summary>
		protected PDEModelingDSLHelpKeywordHelperBase()
			: base() { }
