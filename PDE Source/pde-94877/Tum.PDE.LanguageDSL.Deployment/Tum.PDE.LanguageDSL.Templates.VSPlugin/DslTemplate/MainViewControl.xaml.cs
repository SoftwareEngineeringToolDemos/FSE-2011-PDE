...
namespace $LanguageNamespace$
{
	...
	/// </summary>
    public partial class MainViewControl : $LanguageNamespace$.View.DslPluginMainControl
	{
		/// <summary>
		/// Constructor
		/// </summary>
        ...
        public override void SetViewModel($LanguageNamespace$.ViewModel.$LanguageName$MainViewModel viewModel)
        {
            ...
            viewModel.Ribbon = ribbonControl;
        }
