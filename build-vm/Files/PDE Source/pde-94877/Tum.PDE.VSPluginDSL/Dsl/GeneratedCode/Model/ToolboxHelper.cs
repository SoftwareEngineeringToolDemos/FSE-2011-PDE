...
namespace Tum.PDE.VSPluginDSL
{
	...
	/// </remarks>
	public partial class VSPluginDSLToolboxHelper : VSPluginDSLToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new VSPluginDSLToolboxHelper.
		/// </summary>
		public VSPluginDSLToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	/// Helper class used to create and initialize toolbox items for this DSL.
	/// </summary>
	public abstract class VSPluginDSLToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify VSPluginDSL toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "VSPluginDSL..";

		private global::System.IServiceProvider sp;
		
		/// <summary>
		/// Constructs a new VSPluginDSLToolboxHelperBase.
		/// </summary>
		protected VSPluginDSLToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
