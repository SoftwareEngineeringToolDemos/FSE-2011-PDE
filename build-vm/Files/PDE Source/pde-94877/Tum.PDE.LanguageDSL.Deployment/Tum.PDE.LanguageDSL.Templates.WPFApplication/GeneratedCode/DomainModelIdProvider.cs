...
namespace Tum.VModellXT
{
	...
	/// </summary>
	public partial class VModellXTDomainModelIdProvider : VModellXTDomainModelIdProviderBase
	{
		#region Singleton Instance
		/// <summary>
		/// Singleton instance.
		/// </summary>
		private static VModellXTDomainModelIdProvider instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static VModellXTDomainModelIdProvider Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (VModellXTDomainModelIdProvider.instance == null)
					VModellXTDomainModelIdProvider.instance = new VModellXTDomainModelIdProvider();
				return VModellXTDomainModelIdProvider.instance;
			}
		}
		private VModellXTDomainModelIdProvider(){}
		#endregion
	}
	...
	/// </summary>
	public abstract class VModellXTDomainModelIdProviderBase : DslEditorModeling::IModelElementIdProvider
	{
		...
		/// Constructor.
		/// </summary>
		protected VModellXTDomainModelIdProviderBase()
		{
