...
namespace Tum.PDE.ModelingDSL
{
	...
	/// </remarks>
	public partial class PDEModelingDSLToolboxHelper : PDEModelingDSLToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new PDEModelingDSLToolboxHelper.
		/// </summary>
		public PDEModelingDSLToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	/// Helper class used to create and initialize toolbox items for this DSL.
	/// </summary>
	public abstract class PDEModelingDSLToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify PDEModelingDSL toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "PDEModelingDSL..";

		private global::System.IServiceProvider sp;
		
		/// <summary>
		/// Constructs a new PDEModelingDSLToolboxHelperBase.
		/// </summary>
		protected PDEModelingDSLToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
