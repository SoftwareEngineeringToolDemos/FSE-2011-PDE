...
namespace Tum.PDE.LanguageDSL
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.LanguageDSLEditorFactoryId)]
	internal partial class LanguageDSLEditorFactory : LanguageDSLEditorFactoryBase
	{
		/// <summary>
	...
	/// </summary>
	internal abstract class LanguageDSLEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new LanguageDSLDocData(this.ServiceProvider, typeof(LanguageDSLEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new LanguageDSLDocView(docData, this.ServiceProvider);
		}
	}
}
