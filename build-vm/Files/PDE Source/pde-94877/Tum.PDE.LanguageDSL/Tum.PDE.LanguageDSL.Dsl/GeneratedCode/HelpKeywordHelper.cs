...
namespace Tum.PDE.LanguageDSL
{
	...
	/// </remarks>
	public partial class LanguageDSLHelpKeywordHelper : LanguageDSLHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new LanguageDSLHelpKeywordHelper.
		/// </summary>
		protected LanguageDSLHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the LanguageDSLHelpKeywordHelper.
		/// </summary>
		public static LanguageDSLHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class LanguageDSLHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new LanguageDSLHelpKeywordHelperBase.
		/// </summary>
		protected LanguageDSLHelpKeywordHelperBase()
			: base() { }
