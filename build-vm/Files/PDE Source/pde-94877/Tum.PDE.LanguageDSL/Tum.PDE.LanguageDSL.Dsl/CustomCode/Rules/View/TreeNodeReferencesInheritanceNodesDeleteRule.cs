...
{
    [RuleOn(typeof(TreeNodeReferencesInheritanceNodes), FireTime = TimeToFire.TopLevelCommit)]
    public class TreeNodeReferencesInheritanceNodesDeleteRule : DeletingRule
    {
