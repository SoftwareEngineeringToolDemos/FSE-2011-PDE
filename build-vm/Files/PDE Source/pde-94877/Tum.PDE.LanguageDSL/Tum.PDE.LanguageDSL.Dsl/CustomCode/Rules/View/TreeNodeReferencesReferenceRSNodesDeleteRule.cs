...
{
    [RuleOn(typeof(TreeNodeReferencesReferenceRSNodes), FireTime = TimeToFire.TopLevelCommit)]
    public class TreeNodeReferencesReferenceRSNodesDeleteRule : DeletingRule
    {
