...
{
    public class RelationshipShapeClassSelectableViewModel : SelectableViewModel
    {
        private RelationshipShapeClass shapeClass;
        ...
        public RelationshipShapeClassSelectableViewModel(ViewModelStore viewModelStore, RelationshipShapeClass element)
