...
namespace Tum.TestLanguage
{
	...
	public abstract partial class DefaultContextModelContextBase : DslEditorModeling::ModelContext
	{
			...
			: base(modelData)
        {
			...
			//validationController = TestLanguageValidationController.Instance;
        ...
        /// Domain Class ID.
        /// </summary>
		public static readonly System.Guid DomainClassId = new System.Guid("a8ec1bce-0f9a-4378-99a8-924b9dc15939");
		...
		{ 
			get{ return TestLanguageValidationController.Instance; }
		}		
		...
		public override string SerializedModel
		{
			get
			{
				global::Tum.TestLanguage.DomainModel modelRoot = this.RootElement as global::Tum.TestLanguage.DomainModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Tum.TestLanguage.TestLanguageSerializationHelper.Instance.GetSerializedModelStringDomainModel(modelRoot, this.Encoding, DslEditorModeling::SerializationMode.InternalToString);
				}
				return modelFile;
			}
		}
		...
		public override string SerializedFullModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::Tum.TestLanguage.TestLanguageSerializationHelper.Instance.GetSerializedModelStringDomainModel(modelRoot, this.Encoding, DslEditorModeling::SerializationMode.InternalFullToString);
				}
				return modelFile;
			}
		}		
