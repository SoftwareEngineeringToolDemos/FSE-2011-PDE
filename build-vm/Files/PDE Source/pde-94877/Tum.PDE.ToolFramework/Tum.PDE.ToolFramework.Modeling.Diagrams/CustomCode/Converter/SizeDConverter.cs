...
{
    /// <remarks>
    /// Based on Dsl-Tools Diagrams SizeDConverter implementation.
    /// </remarks>
    public class SizeDConverter : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            if (s != null)
            {
                ...
                if (dArr.Length == 2)
                    return new SizeD(dArr[0], dArr[1]);
               
                throw new System.ArgumentException("ParseSizeDException from " + s, "value");
            }
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            if (destinationType == typeof(string) && (value is SizeD))
            {
                ...
                string[] sArr = new string[] {
                                               typeConverter.ConvertToString(context, culture, sizeD.Width), 
                                               typeConverter.ConvertToString(context, culture, sizeD.Height) };
