...
namespace Tum.PDE.ToolFramework.Modeling.Diagrams
{
	...
	/// </remarks>
	public partial class DiagramsDSLHelpKeywordHelper : DiagramsDSLHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DiagramsDSLHelpKeywordHelper.
		/// </summary>
		protected DiagramsDSLHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DiagramsDSLHelpKeywordHelper.
		/// </summary>
		public static DiagramsDSLHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DiagramsDSLHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DiagramsDSLHelpKeywordHelperBase.
		/// </summary>
		protected DiagramsDSLHelpKeywordHelperBase()
			: base() { }
