...
namespace Tum.PDE.ToolFramework.Modeling.Diagrams
{
	...
	partial class DiagramsDSLDomainModel
	{
		///<Summary>
		...
		partial void InitializeSerialization(DslModeling::Store store)
		{
			...
			DiagramsDSLSerializationHelper.Instance.InitializeSerialization(store);	
		}
	}
	...
	public abstract partial class DiagramsDSLSerializationHelperBase
	{
		...
		/// Constructor
		/// </summary>
		protected DiagramsDSLSerializationHelperBase() { }
		#endregion
		...
		internal protected virtual void InitializeSerialization(DslModeling::Store store)
		{
			...
			DslModeling::IMonikerResolver monikerResolver = store.FindMonikerResolver(DiagramsDSLDomainModel.DomainModelId);
			if (monikerResolver == null)
			{
				monikerResolver = new TestDslDefinitionSerializationBehaviorMonikerResolver(store, directory);
				store.AddMonikerResolver(DiagramsDSLDomainModel.DomainModelId, monikerResolver);
			}
			
			// Add serialization behaviors
			directory.AddBehavior(TestDslDefinitionSerializationBehavior.Instance);
		}
	...
	/// Helper class for serializing and deserializing DiagramsDSL models.
	/// </summary>
	public sealed partial class DiagramsDSLSerializationHelper : DiagramsDSLSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Private constructor to prevent direct instantiation.
		/// </summary>
		private DiagramsDSLSerializationHelper() : base () { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static DiagramsDSLSerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static DiagramsDSLSerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (DiagramsDSLSerializationHelper.instance == null)
					DiagramsDSLSerializationHelper.instance = new DiagramsDSLSerializationHelper();
				return DiagramsDSLSerializationHelper.instance;
			}
		}
		#endregion
	}
...
namespace Tum.PDE.ToolFramework.Modeling.Diagrams
{
	...
	partial class DiagramsDSLSerializationHelperBase
	{
	
		/// <summary>
		/// Loads a DiagramsModel instance into the default partition of the given store, and ignore serialization result.
		/// </summary>
		/// <param name="store">The new DiagramsModel instance will be created into the default partition of this store.</param>
		/// <param name="fileName">Name of the file from which the DiagramsModel instance will be deserialized.</param>
		...
		/// </param>
		/// <returns>The loaded DiagramsModel instance.</returns>
		public virtual DiagramsModel LoadModel(DslModeling::Store store, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			#region Check Parameters
			if (store == null) 
				throw new global::System.ArgumentNullException("store");
		...
		/// <summary>
		/// Loads a DiagramsModel instance into the default partition of the given store.
		/// </summary>
		...
		/// </param>
		/// <returns>The loaded DiagramsModel instance.</returns>
		public virtual DiagramsModel LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Store store, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			#region Check Parameters
			if (store == null) 
				throw new global::System.ArgumentNullException("store");
		...
		/// <summary>
		/// Loads a DiagramsModel instance.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="partition">Partition in which the new DiagramsModel instance will be created.</param>
		/// <param name="fileName">Name of the file from which the DiagramsModel instance will be deserialized.</param>
		/// <param name="schemaResolver">
		/// An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).
		/// If null is passed, schema validation will not be performed.
		...
		public virtual DiagramsModel LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			#region Check Parameters
			...
			{
				throw new global::System.InvalidOperationException(DiagramsDSLDomainModel.SingletonResourceManager.GetString("MissingTransaction"));
			}
			
			DiagramsModel modelRoot = null;
			DslModeling::DomainXmlSerializerDirectory directory = this.GetDirectory(partition.Store);
			DslModeling::DomainClassXmlSerializer modelRootSerializer = directory.GetSerializer(DiagramsModel.DomainClassId);
			global::System.Diagnostics.Debug.Assert(modelRootSerializer != null, "Cannot find serializer for DiagramsModel!");
				...
				using (global::System.IO.FileStream fileStream = global::System.IO.File.OpenRead(fileName))
				{
					...
					using (DslModeling::Transaction t = partition.Store.TransactionManager.BeginTransaction("Load Model from " + fileName, true, transactionContext))
					{
						...
						if (fileStream.Length > 5)
						{
							try
							{
								global::System.Xml.XmlReaderSettings settings = DiagramsDSLSerializationHelper.Instance.CreateXmlReaderSettings(serializationContext, false);
								using (global::System.Xml.XmlReader reader = global::System.Xml.XmlReader.Create(fileStream, settings))
								{
									...
									modelRoot = modelRootSerializer.TryCreateInstance(serializationContext, reader, partition) as DiagramsModel;
		...
		/// <param name="modelRoot">DiagramsModel instance to be saved.</param>
		/// <param name="fileName">Name of the file in which the DiagramsModel instance will be saved.</param>
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, DiagramsModel modelRoot, string fileName)
		{
		...
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, DiagramsModel modelRoot, string fileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <param name="modelRoot">DiagramsModel instance to be saved.</param>
		/// <param name="fileName">Name of the file in which the DiagramsModel instance will be saved.</param>
		/// <param name="encoding">Encoding to use when saving the DiagramsModel instance.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveModel(DslModeling::SerializationResult serializationResult, DiagramsModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		/// <param name="encoding">Encoding to use when saving the DiagramsModel instance.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		/// <returns>In-memory stream containing the serialized DiagramsModel instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		private global::System.IO.MemoryStream InternalSaveModel(DslModeling::SerializationResult serializationResult, DiagramsModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
		...
		/// <summary>
		/// Helper method to create and initialize a new DiagramsModel.
		/// </summary>
		internal protected virtual DiagramsModel CreateModelHelper(DslModeling::Partition modelPartition)
		{
			DiagramsModel model = new DiagramsModel(modelPartition);
			return model;
		}
		...
		protected virtual void CheckVersion(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader)
		{
			...
			if (dslVersionStr != null)
			{
				try
				{
					...
					{
						TestDslDefinitionSerializationBehaviorSerializationMessages.VersionMismatch(serializationContext, reader, expectedVersion, actualVersion);
					}
				}
				catch (global::System.ArgumentException)
				{
					TestDslDefinitionSerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "dslVersion", typeof(global::System.Version), dslVersionStr);
				}
		...
		protected virtual global::System.Xml.XmlReader TryCreateValidatingReader(DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (success && schemaSet.Count > 0)
			{
				...
				TestDslDefinitionSerializationBehaviorSchemaValidationCallback validationCallback = new TestDslDefinitionSerializationBehaviorSchemaValidationCallback(serializationContext);
		...
		protected static bool ResolveSchema(string targetNamespace, global::System.Xml.Schema.XmlSchemaSet schemaSet, DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (schemas != null && schemas.Count > 0)
			{
				if (schemas.Count > 1)
				{
					TestDslDefinitionSerializationBehaviorSerializationMessages.AmbiguousSchema(serializationContext, reader, targetNamespace, schemas[0]);
				}
				schemaSet.Add(targetNamespace, schemas[0]);
				return true;
			}
	
			TestDslDefinitionSerializationBehaviorSerializationMessages.NoSchema(serializationContext, reader, targetNamespace);
			return false;
		}
		...
		/// </summary>
		private sealed class TestDslDefinitionSerializationBehaviorSchemaValidationCallback
		{
			...
			internal TestDslDefinitionSerializationBehaviorSchemaValidationCallback(DslModeling::SerializationContext serializationContext)
			{
				global::System.Diagnostics.Debug.Assert(serializationContext != null);
			...
			internal void Handler(object sender, global::System.Xml.Schema.ValidationEventArgs e)
			{
				...
				if (this.serializationContext != null)
					TestDslDefinitionSerializationBehaviorSerializationMessages.SchemaValidationError(this.serializationContext, this.reader, e.Message);
			}
			#endregion
		}
		...
		public virtual string GetSerializedModelString(global::Tum.PDE.ToolFramework.Modeling.Diagrams.DiagramsModel modelRoot, global::System.Text.Encoding encoding)
		{
...
namespace Tum.PDE.ToolFramework.Modeling.Diagrams
{
	...
	public partial class DiagramsModel
	{
		...
		private void ValidateMonikerAmbiguity(DslValidation::ValidationContext context)
		{
			...
			global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> monikerResolvers = DiagramsDSLSerializationHelper.Instance.GetMonikerResolvers(this.Store);
						...
						{	// Ambiguous moniker detected.
							context.LogError(
								string.Format(
									...
									DiagramsDSLDomainModel.SingletonResourceManager.GetString("AmbiguousMoniker"),
									amEx.Moniker,
