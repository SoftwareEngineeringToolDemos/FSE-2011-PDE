...
{
	partial class StateMachineLanguageDomainModel
	{
		///<Summary>
		...
		partial void InitializeSerialization(DslModeling::Store store)
		{
			// Register the serializers and moniker resolver for this model
			 StateMachineLanguageSerializationHelper.Instance.InitializeSerialization(store);	
		}
	}
}
...
namespace Tum.StateMachineDSL
{
	...
	/// <summary>
	/// Helper class for serializing and deserializing StateMachineLanguage models.
	/// </summary>
	public abstract partial class StateMachineLanguageSerializationHelperBase : DslEditorModeling::SerializationHelper
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected StateMachineLanguageSerializationHelperBase() { }
		#endregion
		...
		internal protected virtual void InitializeSerialization(DslModeling::Store store)
		{
			...
			directory.AddBehavior(StateMachineLanguageSerializationBehavior.Instance);
		}
		...
		public static void InitializeSerializers(DslModeling::DomainXmlSerializerDirectory directory, DslModeling::DomainDataDirectory domainDataDirectory)
		{
			...
			typeEmbeddedDerivedNameTypes.Add(global::Tum.StateMachineDSL.StateMachineDomainModel.DomainClassId, new System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<System.Guid>>());
			// add dictionary informations...
			typeDerivedNameTypes.Add(global::Tum.StateMachineDSL.StateBase.DomainClassId, new System.Collections.Generic.Dictionary<string, System.Guid>());
			AddTypeDerivedNameTypesElement(global::Tum.StateMachineDSL.StateBase.DomainClassId, "State", global::Tum.StateMachineDSL.State.DomainClassId);
			AddTypeDerivedNameTypesElement(global::Tum.StateMachineDSL.StateBase.DomainClassId, "StartState", global::Tum.StateMachineDSL.StartState.DomainClassId);
			AddTypeDerivedNameTypesElement(global::Tum.StateMachineDSL.StateBase.DomainClassId, "EndState", global::Tum.StateMachineDSL.EndState.DomainClassId);
		...
		#region Serialization Methods for StateMachineDomainModel
		/// <summary>
		/// Loads a StateMachineDomainModel instance.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the load operation.</param>
		/// <param name="partition">Partition in which the new StateMachineDomainModel instance will be created.</param>
		/// <param name="fileName">Name of the file from which the StateMachineDomainModel instance will be deserialized.</param>
        ...
        public virtual global::Tum.StateMachineDSL.StateMachineDomainModel LoadModelStateMachineDomainModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
        {
            #region Check Parameters
            ...
            {
                throw new global::System.InvalidOperationException(StateMachineLanguageDomainModel.SingletonResourceManager.GetString("MissingTransaction"));
            }
			...
			DslModeling::DomainClassXmlSerializer modelRootSerializer = directory.GetSerializer(global::Tum.StateMachineDSL.StateMachineDomainModel.DomainClassId);
			global::System.Diagnostics.Debug.Assert(modelRootSerializer != null, "Cannot find serializer for StateMachineDomainModel!");
			if (modelRootSerializer != null)
			{
				...
				try
				{
					...
					//{
						...
						{
							global::System.Xml.XmlReaderSettings settings = StateMachineLanguageSerializationHelper.Instance.CreateXmlReaderSettings(serializationContext, false);
							using (global::System.Xml.XmlReader reader = global::System.Xml.XmlReader.Create(fileStream, settings))
							{
								...
								{	
									...
									modelRoot = modelRootSerializer.TryCreateInstance(serializationContext, reader, partition) as global::Tum.StateMachineDSL.StateMachineDomainModel;
									if (modelRoot != null && !serializationResult.Failed)
									{
										modelRoot.DomainFilePath = fileName;
										this.ReadRootElementStateMachineDomainModel(serializationContext, modelRoot, reader, schemaResolver);
									}
						...
						if(modelRoot == null && !serializationResult.Failed)
						{
							...
							modelRoot = this.CreateModelHelperStateMachineDomainModel(partition);
							modelRoot.DomainFilePath = fileName;
						}
						//if (t.IsActive)
						//	t.Commit();
		...
		/// <summary>
		/// Helper method to create and initialize a new StateMachineDomainModel.
		/// </summary>
		internal protected virtual global::Tum.StateMachineDSL.StateMachineDomainModel CreateModelHelperStateMachineDomainModel(DslModeling::Partition modelPartition)
		{
			global::Tum.StateMachineDSL.StateMachineDomainModel model = new global::Tum.StateMachineDSL.StateMachineDomainModel(modelPartition, 
				global::Tum.StateMachineDSL.StateMachineLanguageDomainModelIdProvider.Instance.AssignId(null));
			if( StateMachineLanguageElementNameProvider.Instance.HasName(model) )
				StateMachineLanguageElementNameProvider.Instance.SetName(model, "StateMachineDomainModel");
		...
		protected virtual void ReadRootElementStateMachineDomainModel(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement rootElement, global::System.Xml.XmlReader reader, DslModeling::ISchemaResolver schemaResolver)
		{
			#region Check Parameters
		...
		/// <param name="modelRoot">StateMachineDomainModel instance to be saved.</param>
		/// <param name="fileName">Name of the file in which the StateMachineDomainModel instance will be saved.</param>
		/// <param name="encoding">Encoding to use when saving the StateMachineDomainModel instance.</param>
		...
		public virtual void SaveModelStateMachineDomainModel(DslModeling::SerializationResult serializationResult, global::Tum.StateMachineDSL.StateMachineDomainModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
			...
			try
			{
				...
				global::System.Xml.XmlWriterSettings settings = StateMachineLanguageSerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, false, encoding);
				...
				this.WriteRootElementStateMachineDomainModel(serializationContext, modelRoot, writer, options);
		...
		/// <returns>In-memory stream containing the serialized StateMachineDomainModel instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Reliability", "CA2000:Dispose objects before losing scope")]
		private global::System.IO.MemoryStream InternalSaveModelStateMachineDomainModel(DslModeling::SerializationResult serializationResult, global::Tum.StateMachineDSL.StateMachineDomainModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue, DslEditorModeling.SerializationMode serializationMode)
		{
			#region Check Parameters
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
        [global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
        public virtual void TemporarlySaveModelStateMachineDomainModel(DslModeling::SerializationResult serializationResult, global::Tum.StateMachineDSL.StateMachineDomainModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
        {
            #region Check Parameters
            if (serializationResult == null)
                throw new global::System.ArgumentNullException("serializationResult");
		...
		public virtual void WriteRootElementStateMachineDomainModel(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement rootElement, global::System.Xml.XmlWriter writer, DslEditorModeling::SerializationOptions options)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert(serializationContext != null);
			if (serializationContext == null)
		...
		public virtual string GetSerializedModelStringStateMachineDomainModel(global::Tum.StateMachineDSL.StateMachineDomainModel modelRoot, global::System.Text.Encoding encoding, DslEditorModeling.SerializationMode serializationMode)
		{
			...
			using (global::System.IO.MemoryStream modelFileContent = this.InternalSaveModelStateMachineDomainModel(serializationResult, modelRoot, string.Empty, encoding, false, serializationMode))
			{
	...
	/// <summary>
	/// Double derived helper class for serializing and deserializing StateMachineLanguage models.
	/// </summary>
	public sealed partial class StateMachineLanguageSerializationHelper : StateMachineLanguageSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		private StateMachineLanguageSerializationHelper() : base() { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static StateMachineLanguageSerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static StateMachineLanguageSerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (StateMachineLanguageSerializationHelper.instance == null)
					StateMachineLanguageSerializationHelper.instance = new StateMachineLanguageSerializationHelper();
				return StateMachineLanguageSerializationHelper.instance;
			}
		}
		#endregion
	}
