...
namespace Tum.StateMachineDSL
{
	...
	/// </summary>
	public partial class StateMachineLanguageDomainModelIdProvider : StateMachineLanguageDomainModelIdProviderBase
	{
		#region Singleton Instance
		/// <summary>
		/// Singleton instance.
		/// </summary>
		private static StateMachineLanguageDomainModelIdProvider instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static StateMachineLanguageDomainModelIdProvider Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (StateMachineLanguageDomainModelIdProvider.instance == null)
					StateMachineLanguageDomainModelIdProvider.instance = new StateMachineLanguageDomainModelIdProvider();
				return StateMachineLanguageDomainModelIdProvider.instance;
			}
		}
		private StateMachineLanguageDomainModelIdProvider(){}
		#endregion
	}
	...
	/// </summary>
	public abstract class StateMachineLanguageDomainModelIdProviderBase : DslEditorModeling::IModelElementIdProvider
	{
		...
		/// Constructor.
		/// </summary>
		protected StateMachineLanguageDomainModelIdProviderBase()
		{
        ...
        public virtual bool RemoveKey(DslModeling::ModelElement modelElement, System.Collections.Generic.List<DslEditorModeling::IDomainModelServices> servicesToDiscard)
		{
			...
			discard.Add(StateMachineLanguageDomainModelServices.Instance);

			foreach(DslEditorModeling::IDomainModelServices externService in StateMachineLanguageDomainModelExtensionServices.Instance.ExternServices)
			{
