...
namespace Tum.FamilyTreeDSL
{
	...
	public partial class FamilyTreeDSLPersonSerializer : DslEditorModeling::SerializationDomainClassXmlSerializer
	{
			...
			if (!serializationContext.Result.Failed)
			{
				if (!reader.IsEmptyElement)
				{
					...
					while (!serializationContext.Result.Failed && !reader.EOF && reader.NodeType == global::System.Xml.XmlNodeType.Element)
					{
						...
						{
							// Encountered one unknown XML element, skip it and keep reading.
							FamilyTreeDSLSerializationBehaviorSerializationMessages.UnexpectedXmlElement(serializationContext, reader, "Person");
							DslModeling::SerializationUtilities.Skip(reader);
						}
					}
				}
		...
		protected override void ReadPropertiesFromAttributes(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				ReadPropertyAsAttributeName(serializationContext, instanceOfPerson, reader);
			}
			if (!serializationContext.Result.Failed)
			{
			...
			if (!serializationContext.Result.Failed)
			{
				ReadPropertyAsAttributeHobbies(serializationContext, instanceOfPerson, reader);
			}
		}
		...
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity", Justification = "Generated code.")]
		protected virtual void ReadPropertyAsAttributeName(DslModeling::SerializationContext serializationContext, global::Tum.FamilyTreeDSL.Person instance, global::System.Xml.XmlReader reader)
		{
			// Name
			if (!serializationContext.Result.Failed)
			{
		...
		/// <summary>
		/// Read property Hobbies that needed to be serialized as XML attribute.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="instance">Person instance to be serialized.</param>
		/// <param name="reader">XmlReader.</param> 
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity", Justification = "Generated code.")]
		protected virtual void ReadPropertyAsAttributeHobbies(DslModeling::SerializationContext serializationContext, global::Tum.FamilyTreeDSL.Person instance, global::System.Xml.XmlReader reader)
		{
			// Hobbies
			if (!serializationContext.Result.Failed)
			{
				string attribValue = FamilyTreeDSLSerializationHelper.Instance.ReadAttribute(serializationContext, instance, reader, "Hobbies");
				if( attribValue != null )
					instance.Hobbies = global::Tum.FamilyTreeDSL.FamilyTreeDSLSerializationHelper.Instance.ConvertTypedObjectFrom(serializationContext, instance, "Hobbies", attribValue, typeof(global::System.String), false) as global::System.String;
			}
		...
		protected override DslModeling::ModelElement CreateInstance(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader, DslModeling::Partition partition)
		{
			...
			try
			{
				...
				{	// Create a default Id.
					id = FamilyTreeDSLDomainModelIdProvider.Instance.GenerateNewKey();
					DslModeling::SerializationUtilities.AddMessage(serializationContext,DslModeling::SerializationMessageKind.Warning,
						"Missing 'Id' attribute, a new Guid " + id.ToString() + " is auto-generated. Element type (Person)",
		    			reader as global::System.Xml.IXmlLineInfo);
					//FamilyTreeDSLSerializationBehaviorSerializationMessages.MissingId(serializationContext, reader, id);
				}
				else
				...
				return new global::Tum.FamilyTreeDSL.Person(partition, new DslModeling::PropertyAssignment(DslModeling::ElementFactory.IdPropertyAssignment, id));
			}
			catch (global::System.ArgumentNullException /* anEx */)
			{	
				FamilyTreeDSLSerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "Id", typeof(global::System.Guid), idStr);
		...
		protected override void WritePropertiesAsAttributes(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer, DslEditorModeling::SerializationOptions options)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				WritePropertyAsAttributeHobbies(serializationContext, instance, writer, options);
			}
		}
		...
		/// <param name="options">Serialization options.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity", Justification = "Generated code.")]
		protected virtual void WritePropertyAsAttributeName(DslModeling::SerializationContext serializationContext, global::Tum.FamilyTreeDSL.Person instance, global::System.Xml.XmlWriter writer, DslEditorModeling::SerializationOptions options)
		{
			// Name
		...
		/// <summary>
		/// Write property Hobbies that need to be serialized as XML attribute.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="instance">Person instance to be serialized.</param>
		/// <param name="writer">XmlWriter to write serialized data to.</param> 
		/// <param name="options">Serialization options.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity", Justification = "Generated code.")]
		protected virtual void WritePropertyAsAttributeHobbies(DslModeling::SerializationContext serializationContext, global::Tum.FamilyTreeDSL.Person instance, global::System.Xml.XmlWriter writer, DslEditorModeling::SerializationOptions options)
		{
			// Hobbies
			...
			{
				FamilyTreeDSLSerializationHelper.Instance.WriteAttributeString(serializationContext, instance, writer, "Hobbies", valueHobbies.ToString());
			}
		}
...
namespace Tum.FamilyTreeDSL
{
	...
	public partial class FamilyTreeDSLFamilyTreePersonSerializer : Tum.FamilyTreeDSL.FamilyTreeDSLPersonSerializer
	{
		...
		protected override void ReadPropertiesFromAttributes(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlReader reader)
		{
			...
			if (!serializationContext.Result.Failed)
			{
				ReadPropertyAsAttributeName(serializationContext, instanceOfFamilyTreePerson, reader);
			}
			if (!serializationContext.Result.Failed)
			{
			...
			if (!serializationContext.Result.Failed)
			{
				ReadPropertyAsAttributeHobbies(serializationContext, instanceOfFamilyTreePerson, reader);
			}
		}
