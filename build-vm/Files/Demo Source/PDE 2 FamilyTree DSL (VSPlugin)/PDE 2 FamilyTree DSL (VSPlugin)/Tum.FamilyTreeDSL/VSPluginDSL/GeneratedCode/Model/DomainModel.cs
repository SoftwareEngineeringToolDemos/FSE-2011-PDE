...
namespace Tum.FamilyTreeDSL
{
	...
	[DslModeling::DomainObjectId("71e634b6-f895-45d5-bdbe-95853262c1a8")]
	...
	public partial class FamilyTreeDSLDomainModel : DslEditorModeling::DomainModelBase
	{
		...
		/// </summary>
		public static readonly new global::System.Guid DomainModelId = new System.Guid("71e634b6-f895-45d5-bdbe-95853262c1a8");
		...
		public sealed override DslModeling::ModelElement CreateElement(DslModeling::Partition partition, global::System.Type elementType, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			if (createElementMap == null)
			{
				...
				createElementMap.Add(typeof(FamilyTreePerson), 2);
				createElementMap.Add(typeof(Pet), 3);
				createElementMap.Add(typeof(PersonShape), 4);
				createElementMap.Add(typeof(ParentOfShape), 5);
				createElementMap.Add(typeof(MarriedToShape), 6);
			}
			int index;
			...
			switch (index)
			{
				...
				case 2: return new FamilyTreePerson(partition, propertyAssignments);
				case 3: return new Pet(partition, propertyAssignments);
				case 4: return new PersonShape(partition, propertyAssignments);
				case 5: return new ParentOfShape(partition, propertyAssignments);
				case 6: return new MarriedToShape(partition, propertyAssignments);
				default: return null;
			}
		}
