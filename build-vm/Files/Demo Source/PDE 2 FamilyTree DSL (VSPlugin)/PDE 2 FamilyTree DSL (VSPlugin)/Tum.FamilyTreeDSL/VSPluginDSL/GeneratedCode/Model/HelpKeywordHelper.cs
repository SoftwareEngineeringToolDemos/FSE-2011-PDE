...
namespace Tum.FamilyTreeDSL
{
	...
	/// </remarks>
	public partial class FamilyTreeDSLHelpKeywordHelper : FamilyTreeDSLHelpKeywordHelperBase 
	{
		/// <summary>
		/// Constructs a new FamilyTreeDSLHelpKeywordHelper.
		/// </summary>
		protected FamilyTreeDSLHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the FamilyTreeDSLHelpKeywordHelper.
		/// </summary>
		public static FamilyTreeDSLHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class FamilyTreeDSLHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new FamilyTreeDSLHelpKeywordHelperBase.
		/// </summary>
		protected FamilyTreeDSLHelpKeywordHelperBase()
			: base() { }
